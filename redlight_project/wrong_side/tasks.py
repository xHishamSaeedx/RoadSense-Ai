...
def capture_frames2():
    ...
    npmodel = YOLO("C:\\Users\\m_his\\OneDrive\\Pictures\\Documents\\GitHub\\Roadsense_django\\redlight_project\\wrong_side\\AiModels\\bestshafaat.pt")
            ...
            for results in resultsTracker:
                ...
                if limits2[0]< cx <limits2[2] and limits2[1]-20 < cy < limits2[1]+20 and int(Id) :
                    ...
                    if temp_data.loc[temp_data['ID'] == Id, 'check'].values[0] == True:
                        ...
                        cv2.imwrite(f"C:\\Users\\m_his\\OneDrive\\Pictures\\Documents\\GitHub\\Roadsense_django\\redlight_project\\wrong_side\\vehicle_pictures\\{Id}.jpg", vehicle_img)
                        temp_data.loc[temp_data['ID'] == Id, 'Vehicle'] = f"C:\\Users\\m_his\\OneDrive\\Pictures\\Documents\\GitHub\\Roadsense_django\\redlight_project\\wrong_side\\vehicle_pictures\\{Id}.jpg"
